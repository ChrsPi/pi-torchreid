...
def init_parser():
    ...
    # Datasets
    # ************************************************************
    parser.add_argument("--root", type=str, default="", required=True, help="root path to data directory")
    ...
    # sgd
    parser.add_argument("--momentum", type=float, default=0.9, help="momentum factor for sgd and rmsprop")
    ...
    # adam/amsgrad
    parser.add_argument("--adam-beta1", type=float, default=0.9, help="exponential decay rate for adam's first moment")
    parser.add_argument(
        "--adam-beta2", type=float, default=0.999, help="exponential decay rate for adam's second moment"
    )
    ...
    parser.add_argument("--start-epoch", type=int, default=0, help="manual epoch number (useful when restart)")
    parser.add_argument("--batch-size", type=int, default=32, help="batch size")

    parser.add_argument("--fixbase-epoch", type=int, default=0, help="number of epochs to fix base layers")
    parser.add_argument(
        "--open-layers",
        type=str,
        nargs="+",
    ...
    parser.add_argument(
        "--new-layers", type=str, nargs="+", default=["classifier"], help="newly added layers with default lr"
    )
    parser.add_argument("--base-lr-mult", type=float, default=0.1, help="learning rate multiplier for base layers")

    # ************************************************************
    # Learning rate scheduler options
    # ************************************************************
    parser.add_argument(
        "--lr-scheduler", type=str, default="multi_step", help="learning rate scheduler (see lr_schedulers.py)"
    )
    ...
    parser.add_argument("--resume", type=str, default="", metavar="PATH", help="resume from a checkpoint")
...
def lr_scheduler_kwargs(parsed_args):
    return {"lr_scheduler": parsed_args.lr_scheduler, "stepsize": parsed_args.stepsize, "gamma": parsed_args.gamma}
