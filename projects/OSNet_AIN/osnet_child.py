...
class ChannelGate(nn.Module):
    ...
    def __init__(
        self, in_channels, num_gates=None, return_gates=False, gate_activation="sigmoid", reduction=16, layer_norm=False
    ):
        super().__init__()
...
def osnet_ain_x1_0(num_classes=1000, pretrained=True, loss="softmax", **kwargs):
    model = OSNet(
        num_classes,
        blocks=[[OSBlockINv1, OSBlockINv1], [OSBlock, OSBlockINv1], [OSBlockINv1, OSBlock]],
        layers=[2, 2, 2],
