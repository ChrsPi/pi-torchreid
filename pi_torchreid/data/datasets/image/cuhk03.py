...
from pi_torchreid.utils import logger, mkdir_if_missing, read_json, write_json
    ...
    def preprocess_split(self):
        ...
        def _process_images(img_refs, campid, pid, save_dir):
            ...
            for imgid, img_ref in enumerate(img_refs):
                ...
                img_name = f"{campid + 1:01d}_{pid + 1:03d}_{viewid:01d}_{imgid + 1:02d}.png"
        ...
        def _extract_classic_split(meta_data, test_split):
            ...
            for _i, (campid, pid, img_paths) in enumerate(meta_data):
        ...
        for split_ref in mat["testsets"][0]:
            ...
            train, num_train_pids, num_train_imgs, test, num_test_pids, num_test_imgs = _extract_classic_split(
                meta_detected, test_split
            )
