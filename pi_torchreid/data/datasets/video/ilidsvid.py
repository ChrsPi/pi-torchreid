...
from pi_torchreid.utils import logger, read_json, write_json
    ...
    def prepare_split(self):
        if not osp.exists(self.split_path):
            ...
            for i_split in range(num_splits):
                ...
                train_idxs = sorted(mat_split_data[i_split, num_ids_each:])
                test_idxs = sorted(mat_split_data[i_split, :num_ids_each])
